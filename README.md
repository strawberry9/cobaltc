...
Refer to the CobaltC 1.0 Language Specification - [version 1.0.1](https://raw.githubusercontent.com/strawberry9/cobaltc/main/docs/CobaltC_Specification_1.0.1_Final_Publication_V3.pdf) for more details.

The specifiction is also available here - [version 1.0.1](https://strawberry9.github.io/the-wrong-memory/Appendix_06.html)
